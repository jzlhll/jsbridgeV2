...
https://github.com/lzyzsd/JsBridge 1.0.4的版本还是挺好用的。最新的master，他并没有打包成aar公开，而且master代码已经被各种提交污染导致bug。基本的逻辑图在本文最后：使用的是：**shouldOverrideUrlLoading + Iframe.src**更新的相互通知的机制。那么为了兼容android4.x，必须采用1.0.4版本。

那么我基于该框架，也是为了完全兼容以前的前端H5代码，实现了jsbridge2.0。目前公司日活10w+。
支持androiod5.0+，使用evaluateJavascript和重写，代码上也能简化交互逻辑。

2.0代码在
implementation 'com.github.jzlhll:jsbridgeV2:1.0.9'
参考源码：https://github.com/jzlhll/jsbridgeV2
...
总结了jsbridge的基本逻辑为如下三幅图：
忽略了msgQueue，初始化如何数组转变等细节。了解基本逻辑，
使用的是：
**shouldOverrideurlLoading + Iframe.src**更新的相互通知的机制。
![jsbridge初始化](https://i-blog.csdnimg.cn/blog_migrate/3d5ae0c76da11839511600f5d55b0a73.png =440x400)
![请添加图片描述](https://i-blog.csdnimg.cn/blog_migrate/35158ee5236ebec467fdd08f80555ec9.png  =440x490)
![请添加图片描述](https://i-blog.csdnimg.cn/blog_migrate/4eefa7abb6b969b86361fff3229dcbc0.png  =440x500)
